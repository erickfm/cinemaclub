...
cola.markdown(
    f"""<a target="_self" href="https://cinemaclub.streamlit.app"><img src="https://raw.githubusercontent.com/erickfm/cinemaclub/main/images/cc.png" style="display:block;" width="20%" height="100%"></a>""",
    unsafe_allow_html=1)
